...
public class FileHandler {
    ...
    /**
     * Opens a file chooser dialog to allow the user to select the source directory.
     * The selected directory path is stored in the 'sourceFilesDirectory' variable.
     * If a valid directory is selected, it logs the chosen source directory.
     */
    ...
    /**
     * Opens a file chooser dialog to allow the user to select the destination directory.
     * The selected directory path is stored in the 'destinationDirectory' variable.
     * If a valid directory is selected, it logs the chosen destination directory.
     */
